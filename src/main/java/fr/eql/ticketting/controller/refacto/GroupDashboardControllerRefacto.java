package fr.eql.ticketting.controller.refacto;
...
public class GroupDashboardControllerRefacto {
	...
	public GroupDashboardControllerRefacto(GroupService groupService, MembershipService membershipService,
